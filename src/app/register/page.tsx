...
export default function RegisterPage() {
	...
	const fields = [
		...
		{ name: "nim", label: "NIM", type: "text", placeholder: "1234567890" },
		{
			name: "email",
			label: "Email",
			type: "email",
			...
			<div className="w-full max-w-sm">
				<div className="flex items-center gap-2.5 mb-8">
					...
					<div>
						...
						<p className="text-[11px] text-stone-400">Buat akun baru</p>
					</div>
				</div>

				<div className="bg-white border border-black/8 rounded-2xl p-6">
					<h1 className="text-[17px] font-medium text-stone-900 mb-1">Daftar</h1>
